...
export default function Daftar() {
    ...
    return (
        <>
            <NavbarBack text="Daftar" />
            <main>
                <div className="max-w-lg bg-white min-h-screen mx-auto p-10 pb-0">
                    <p className="font-semibold text-xl text-gray-700">Daftar untuk menjadi salahsatu donatur di KitaBantu</p>
                    <form className="flex flex-col gap-5 my-7">
                        ...
                        <div className="relative w-full">
                            ...
                            <span
                                className="toggle-password absolute translate-y-[-50%] top-[50%] right-4"
